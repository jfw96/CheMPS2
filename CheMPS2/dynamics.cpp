...
"              When a pulse is to be applied (PULSE_APPLY = TRUE) the GROUP might be affected.\n"
"              Please refere to the options PULSE_APPLY and PULSE_SYMMETRY_MAINTAINED to handle this correctly.\n"
"\n"
"       MULTIPLICITY = int\n"
...
"\n"
"       TIME_ORTHO = bool\n"
"              Whether to perform the krylov method orthogonal or not. Has effect for TIME_TYPE = K only. (TRUE or FALSE; default FALSE).\n"
"\n"
"       PULSE_APPLY = bool\n"
"              Set if the external potential is time dependent (TRUE or FALSE; default FALSE). If true all PULSE_* options are mandatory.\n"
"              If true the calculation use GROUP = 0 unless you set PULSE_SYMMETRY_MAINTAINED = TRUE.\n"
"\n"
...
"\n"
"       PULSE_ENVELOP = char ('R','G','C','S','D')\n"
"              Specify the envelop of the electrical pulse.\n"
"              R: rectangle pulse. Starting at PULSE_START_TIME, ends at PULSE_START_TIME + PULSE_DURATION\n"
"              G: sin oscillation within gaussian envelop. Mean value of the gaussian wave at PULSE_START_TIME + 4 PULSE_DURATION.\n"
"              C: the gaussian envelop of option G without the sin oscillation.\n"
"              S: sin oscillation. Starting at time zero, set to zero after PULSE_START_TIME + PULSE_DURATION.\n"
"\n"
