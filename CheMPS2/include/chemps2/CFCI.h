...
#ifndef CFCI_CHEMPS2_H
#define CFCI_CHEMPS2_H
...
//          unsigned int LowestEnergyDeterminant() const;
         ...
         dcomplex Fill2RDM(dcomplex * vector, dcomplex * TwoRDM) const;
...
//          double CalcSpinSquared(double * vector) const;
         ...
         static void FillRandom(const unsigned int vecLength, dcomplex * vec);
         
         //! Set the entries of a vector to zero
         /** \param vecLength The vector length
             \param vec The vector which has to be set to zero */
         static void ClearVector(const unsigned int vecLength, dcomplex * vec);
...
//          //void CheckHamDEBUG() const;
      ...
      protected:
         ...
         void recusion( dcomplex * state, int L,
...
//          void DiagHamSquared(double * output) const;
         ...
         void matvec( dcomplex * input, dcomplex * output ) const;
...
// //==========> Some lapack like routines
         ...
         static dcomplex FCIddot(const unsigned int vecLength, dcomplex * vec1, dcomplex * vec2);

         //! Take the inproduct of two vectors and the Hamiltonian
         /** \param vecLength The vector length
             \param vec1 The first vector
             \param vec2 The second vector
             \return The inproduct < vec1 | vec2 > */         
         dcomplex FCIaHb(const unsigned int vecLength, dcomplex * vec1, dcomplex * vec2);

         //! Copy a vector
         /** \param vecLength The vector length
             \param origin Vector to be copied
             \param target Where to copy the vector to */
         static void FCIdcopy(const unsigned int vecLength, dcomplex * origin, dcomplex * target);
...
//          static double FCIfrobeniusnorm(const unsigned int vecLength, double * vec);
         ...
         static void FCIdaxpy(const unsigned int vecLength, const dcomplex alpha, dcomplex * vec_x, dcomplex * vec_y);
...
// //==========> Protected functions regarding the higher order RDMs
         ...
         void apply_excitation( dcomplex * orig_vector, dcomplex * result_vector, const int crea, const int anni, const int orig_target_irrep ) const;
         ...
         void ActWithNumberOperator(const unsigned int orbIndex, dcomplex * resultVector, dcomplex * sourceVector) const;
      ...
      private:
         ...
         dcomplex * HXVworksmall;
         
         //! Work space of size HXVsizeWorkspace
         dcomplex * HXVworkbig1;
...
//          double Driver3RDM(double * vector, double * output, double * three_rdm, double * fock, const unsigned int orbz) const;
         ...
         static void excite_alpha_omp( const unsigned int dim_new_up, const unsigned int dim_old_up, const unsigned int dim_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );
         static void excite_alpha_first( const unsigned int dim_new_up, const unsigned int dim_old_up, const unsigned int start_down, const unsigned int stop_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );
         static void excite_alpha_second_omp( const unsigned int dim_new_up, const unsigned int dim_old_up, const unsigned int start_down, const unsigned int stop_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );

         //! Beta excitation kernels
         static void excite_beta_omp( const unsigned int dim_up, const unsigned int dim_new_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );
         static void excite_beta_first( const unsigned int dim_up, const unsigned int start_down, const unsigned int stop_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );
         static void excite_beta_second_omp( const unsigned int dim_up, const unsigned int start_down, const unsigned int stop_down, dcomplex * origin, dcomplex * result, int * signmap, int * countmap );
