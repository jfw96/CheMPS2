...
// void CheMPS2::CTwoDMBuilder::updateMovingLeftSafeFirstTime( const int cnt ) {
...
// void CheMPS2::CTwoDMBuilder::updateMovingRightSafe( const int cnt ) {
...
void CheMPS2::CTwoDMBuilder::left_normalize( CTensorT * left_mps, CTensorT * right_mps ) const {
...
void CheMPS2::CTwoDMBuilder::right_normalize( CTensorT * left_mps, CTensorT * right_mps ) const {
