...
CheMPS2::CTensorF0::CTensorF0( const int boundary_index, const int Idiff,
...
CheMPS2::CTensorF0::~CTensorF0() {}

void CheMPS2::CTensorF0::makenew( CTensorT * denTup, CTensorT * denTdown, CTensorO * previous, dcomplex * workmem ) {
   clear();
...
void CheMPS2::CTensorF0::makenew( CTensorL * denL, CTensorT * denTup, CTensorT * denTdown, dcomplex * workmem ) {
   clear();
...
void CheMPS2::CTensorF0::makenewRight( const int ikappa, CTensorT * denTup, CTensorT * denTdown, CTensorO * previous, dcomplex * workmem ) {
...
void CheMPS2::CTensorF0::makenewLeft( const int ikappa, CTensorT * denTup, CTensorT * denTdown, CTensorO * previous, dcomplex * workmem ) {
...
void CheMPS2::CTensorF0::makenewRight( const int ikappa, CTensorL * denL, CTensorT * denTup, CTensorT * denTdown, dcomplex * workmem ) {
   const int NRU    = sector_nelec_up[ ikappa ];
   const int TwoSRU = sector_spin_up[ ikappa ];
   const int IRU    = sector_irrep_up[ ikappa ];
...
void CheMPS2::CTensorF0::makenewLeft( const int ikappa, CTensorL * denL, CTensorT * denTup, CTensorT * denTdown, dcomplex * workmem ) {
   const int NLU    = sector_nelec_up[ ikappa ];
   const int TwoSLU = sector_spin_up[ ikappa ];
   const int ILU    = sector_irrep_up[ ikappa ];
